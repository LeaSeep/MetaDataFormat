...
Hey there! This tutorial should guide you through your own first steps to fill in the Metadata sheet for an example outlined here. Once you are familiar with the principles of the sheet and the requested information it should be easy for you to move on to your own experiments. Remember, you filling in the sheet along with your data will not only have benefits for you (e.g. using ShinyOmics) but also for your group and beyond!
...
### DIY final groups - Section 2 Conducting


### DIY Measurement Matching table - Section 3 Measurement Matching

## Q&A 
Note the tabs to check for the answer!

### QA {.tabset .color-tabs .tabset-pills}
#### asdasdf

#### asdasd

### QA2 {.tabset .color-tabs .tabset-pills}
#### asdasdf
